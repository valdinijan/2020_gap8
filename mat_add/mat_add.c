...
static void cluster_entry(void *arg)
{
  ...
  // Copy matrices 1 and 2 from L2 to shared L1
  rt_dma_copy_t dmaCp;
  rt_dma_memcpy((int)l2_mat, (int)cluster_l1_buff, MAT_SIZE * 2, RT_DMA_DIR_EXT2LOC, 0, &dmaCp);
  ...
  // Copy result matrix from shared L1 to L2
  rt_dma_memcpy((int)l2_mat[2], (int)&cluster_l1_buff[MAT_SIZE * 2], MAT_SIZE, RT_DMA_DIR_LOC2EXT, 0, &dmaCp);
